...
const Testimonials: React.FC = () => {
  ...
  return (
    <section className="py-20 sm:py-28 bg-[#05060a] text-white border-y border-white/5" ref={ref}>
      <div className="container-custom">
        ...
        >
          <p className="font-mono text-[11px] uppercase tracking-[0.2em] text-pink-300/90 mb-3">
            // signal
          </p>
        ...
        <div className="relative max-w-2xl mx-auto">
          <AnimatePresence mode="wait">
            <motion.blockquote
              ...
              className="rounded-3xl border border-white/10 bg-white/[0.04] p-8 sm:p-10 text-center backdrop-blur-sm"
            >
              <Quote className="w-8 h-8 text-sky-400/70 mx-auto mb-5" />
              ...
              <footer>
                ...
                <p className="font-mono text-xs text-white/40 mt-1">{testimonials[currentIndex].role}</p>
              </footer>
            </motion.blockquote>
          </AnimatePresence>
          ...
          <div className="flex items-center justify-center gap-3 mt-6">
            <button
              type="button"
              onClick={prev}
              className="p-2.5 rounded-full border border-white/15 bg-white/5 hover:bg-white/10 transition-colors"
