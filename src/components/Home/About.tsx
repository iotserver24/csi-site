...
const About: React.FC = () => {
  ...
  return (
    <section className="relative py-20 sm:py-28 bg-[#0a0b12] text-white overflow-hidden" ref={ref}>
      <div className="container-custom">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <p className="font-mono text-[11px] uppercase tracking-[0.2em] text-violet-300/90 mb-3">
              // about chapter
            </p>
            <h2 className="font-display text-3xl sm:text-4xl font-extrabold tracking-tight mb-4 leading-tight">
              Where campus tech
              <br />
              <span className="text-white/40">gets serious.</span>
            </h2>
            ...
            <ul className="space-y-3 mb-8">
              {pillars.map((item, index) => (
                <motion.li
                  ...
                  className="flex gap-3 rounded-2xl border border-white/10 bg-white/[0.03] p-4 hover:border-white/20 transition-colors"
                >
                  <span className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-white/5 text-sky-300">
                    <item.icon size={18} />
                  </span>
                  <div>
            ...
            <Link
              href="/team"
              className="inline-flex items-center gap-2 text-sm font-semibold text-sky-300 hover:gap-3 transition-all"
            >
              Meet the core team
              <ArrowRight size={16} />
            </Link>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative aspect-[5/4] rounded-3xl overflow-hidden border border-white/10 shadow-2xl shadow-black/50">
              <Image
                src="/team.jpg"
                alt="CSI NMAMIT team"
                fill
            ...
            <div className="absolute -z-10 -inset-3 rounded-[2rem] bg-gradient-to-br from-sky-500/20 to-violet-600/20 blur-2xl" />
          </motion.div>
        </div>
      </div>
    </section>
